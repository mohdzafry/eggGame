...
void Draw()
{
    ...
    for (int i = 0; i < ((width+16)/2)-9; i++)
        ...
        SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),6);
                cout << eggside<<" Biththara "<<eggside;
        SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),3);
...
void Instructions(){
	...
	string array[5]={"H","E","L","L","0"};
	
	for(int j=0;j<5;j++){
	cout<<array[j];
	PlaySound(TEXT("C:/Users/pcc/Downloads/1stC-Game-main/1stC-Game-main/New folder/Game/Mechanical-Keyboard-single-button-presses-1-www.FesliyanStudios.com.wav"),NULL,SND_SYNC);
      ...
      gotoxy(46,19+chosen);
       ...
       gotoxy(63,19+chosen);
        ...
        if (c=='s')
        {
            if (chosen<6)
            {
            	PlaySound(TEXT("C:/Users/pcc/Downloads/1stC-Game-main/1stC-Game-main/New folder/Game/mixkit-arcade-game-jump-coin-216.wav"),NULL,SND_SYNC);
                chosen+=2;
            }
        }
        if (c=='w')
